...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F0F4FF', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      ...
      {/* Brand header strip */}
      <div style={{ background: 'linear-gradient(135deg, #312E81 0%, #4F46E5 50%, #0EA5E9 100%)', padding: '14px 20px 18px' }}>
        {/* Language selector */}
        <div style={{ display: 'flex', gap: 5, flexWrap: 'wrap', marginBottom: 12, justifyContent: 'flex-end' }}>
          {LANG_ORDER.map(l => (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          {/* Infinity icon (simplified brand representation) */}
          <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, flexShrink: 0 }}>
            ∞
          </div>
          <div>
