  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          fontSize: 48, fontWeight: 800, color: '#1A1A18',
        ...
        <p style={{
          fontSize: 18, color: '#5F5E5A', lineHeight: 1.7,
          maxWidth: 500, marginBottom: 48,
        }}>
          AI-powered tools for report cards, teacher evaluation,
          admissions, and parent communication — built on Supabase and Claude.
        </p>
        ...
        <div style={{
          ...
          {[
            { title: 'Report Cards', desc: 'AI narratives + PDF batch', href: '/report-cards', color: '#0F6E56', bg: '#E1F5EE', status: 'Live' },
            { title: 'Teacher Eval', desc: 'Audio → coaching report', href: '/teacher-eval', color: '#854F0B', bg: '#FAEEDA', status: 'Coming' },
            { title: 'Admissions', desc: 'Lead scoring + CRM', href: '/admissions', color: '#3C3489', bg: '#EEEDFE', status: 'Coming' },
